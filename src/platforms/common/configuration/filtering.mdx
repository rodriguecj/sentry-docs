...
<PlatformSection supported={["javascript", "node"]} notSupported={["javascript.nextjs"]}>
...
<PlatformSection supported={["javascript", "node", "python", "PHP"]} notSupported={["javascript.nextjs"]}>
